...
from chia.server.ws_connection import Direction
...
class TestSimulation:
    ...
    async def test_simulation_1(self, simulation, extra_node, self_hostname):
        ...
        assert len(server1.get_connections(NodeType.FULL_NODE, Direction.Outbound)) >= 1
        ...
        assert len(server3.get_connections(NodeType.FULL_NODE, Direction.Outbound)) >= 2
